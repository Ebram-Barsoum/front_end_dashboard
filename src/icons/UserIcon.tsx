export default function UserIcon(): JSX.Element {
    return (
        ...
        >
            <path
                d="M11.6667 12.25V11.0833C11.6667 10.4645 11.4208 9.871 10.9833 9.43342C10.5457 8.99583 9.95218 8.75 9.33334 8.75H4.66668C4.04784 8.75 3.45435 8.99583 3.01676 9.43342C2.57918 9.871 2.33334 10.4645 2.33334 11.0833V12.25"
                stroke="black"
                strokeWidth="1.5"
                strokeLinecap="round"
